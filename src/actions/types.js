...
export const FETCH_COMMISSION_BONUS= "FETCH_COMMISSION_BONUS";
export const FETCH_COMMISSION_BONUS_SUCCESS = "FETCH_COMMISSION_BONUS_SUCCESS";
export const FETCH_COMMISSION_BONUS_FAILED = "FETCH_COMMISSION_BONUS_FAILED";
export const EDIT_CLIENT_COMMISSION_BONUS = "EDIT_CLIENT_COMMISSION_BONUS";
export const EDIT_RIDE_COMMISSION_BONUS = "EDIT_RIDE_COMMISSION_BONUS";
export const CLEAR_COMMISSION_ERROR = "CLEAR_COMMISSION_ERROR";
